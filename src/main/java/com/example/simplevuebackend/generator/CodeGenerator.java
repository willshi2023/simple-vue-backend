package com.example.simplevuebackend.generator;
...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        //手动配置数据源
        String url="jdbc:mysql://localhost:3306/demo?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8";   //注意修改数据库名
        String name="root";
        String password="root";

        //数据库表的设置
        List<String> listTable = Arrays.asList("t_users");  //设置需要自动代码生成的表名
        List<String> listTableSuffix = Arrays.asList("_b");    //设置 过滤 表的后缀
        List<String> listTablePrefix = Arrays.asList("t_","c_"); //设置 过滤 表的后缀

        //基本信息
        String author = "柯南";    //作者
        String parent = "com.example.simplevuebackend.generator";   //父包名
        String module = "api";   //模块包名
